...
document.getElementById("loginForm").addEventListener("submit", async (e) => {
  ...
  if (error) {
    ...
    if (msg.includes("invalid login credentials")) {
      ...
      showMsg("Akun belum terkonfirmasi. Matikan 'Confirm email' di Supabase Dashboard (Authentication → Sign In/Providers → Email), lalu daftar ulang atau hubungi admin untuk konfirmasi manual.", "error");
    } else if (msg.includes("rate limit")) {
      showMsg("Terlalu banyak percobaan. Tunggu beberapa saat lalu coba lagi.", "error");
    } else {
      showMsg("Gagal masuk: " + error.message, "error");
    }
    renderCaptcha("loginCaptchaCanvas");
    return;
  }
